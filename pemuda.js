...
try {
		...
		const katalog = (teks) => {
             res = pemuda.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© Bal Botz_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             pemuda.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = pemuda.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `${NamaBot}`, "footerText": "*_© Bal Botz_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
pemuda.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© Bal Botz_*", [{buttonId: 'simi', buttonText: {disText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
...
break
case 'allmenu':
        ptod = "6289513005053@s.whatsapp.net"
        stod = `${sender}`
        uwu = '```'
       stst = await pemuda.getStatus(`${sender.split('@')[0]}@c.us`)
				stst = stst.status == 401 ? '' : stst.status
...
│☛Kang Recode : @${ptod.split('@')[08873171079]}
│☛Battery : ${baterai.battery}
│☛Mode : ${publik ? 'Public' : 'Self'}
│☛Total Hit : ${cmhit.length}
│☛Prefix : ${multi ? 'Multi Prefix' : 'No Prefix'}
...
case 'menu':
 ...
 footerText: '*_© GGBotz*',
 description: `Hai kak @${stod.split('@')[0]}, Silahkan pilih menu disini, Kalau lu makek Wa GB/Haram, dan gak muncul, Ketik .allmenu`,
 sections: [
                     {
...
client.browserDescription = ['BAL BOTZ','Desktop','3.0']
